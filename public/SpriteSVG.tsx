export const SpriteSVG = ({ name, className, color, height = 24, width = 24 }: { name: string; className?: string; color?: string; height?: number; width?: number }) => {
  switch (name) {
    ...
    case "dots-close":
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width={width} height={height} fill={color}>
          <path d="M160,128a32,32,0,1,1-32-32A32.03164,32.03164,0,0,1,160,128Zm-112-32a32,32,0,1,0,32,32A32.03164,32.03164,0,0,0,48,96Zm160,0a32,32,0,1,0,32,32A32.03164,32.03164,0,0,0,208,96Z" />
        </svg>
      );
    case "dots-open":
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          <path d="M128,98a30,30,0,1,0,30,30A30.03406,30.03406,0,0,0,128,98Zm0,48a18,18,0,1,1,18-18A18.02031,18.02031,0,0,1,128,146ZM48,98a30,30,0,1,0,30,30A30.03406,30.03406,0,0,0,48,98Zm0,48a18,18,0,1,1,18-18A18.02031,18.02031,0,0,1,48,146ZM208,98a30,30,0,1,0,30,30A30.03406,30.03406,0,0,0,208,98Zm0,48a18,18,0,1,1,18-18A18.02031,18.02031,0,0,1,208,146Z" />
        </svg>
      );
    default:
      return null;
